...
BATCH?=250000
OVERLAP?=2
COMPILE_TIME_PARAMETERS=-DKMER_SIZE=$(K) -DMINIMIZER_SIZE=$(M) -DLOWER_KMER_FREQ=$(L) -DUPPER_KMER_FREQ=$(U) -DLOG_LEVEL=$(LOG) -DDEBUG=$(D) -DTHREAD_PER_TASK=$(T) -DMAX_SEND_BATCH=$(BATCH) -DOVERLAP_LEVEL=$(OVERLAP)
OPT=
